<html lang="en">
  ...
  <body>
    ...
    <div class="jumbotron">
      <div class="container">
        <h1 class="centro">Sisitema de gestión de Incidentes</h1>
        <h2>Restablecer contraseña:</h2>
  			{!! Form::open(['route'=>'password.postReset','method'=>'POST','class'=>'form-horizontal']) !!}
  				...
  				<div class="form-group">
  					{!! form::label('contraseña_confirmacion','Confirmar contraseña:',['class'=>'col-sm-2 control-label']) !!}
  					<div class="col-sm-10">
