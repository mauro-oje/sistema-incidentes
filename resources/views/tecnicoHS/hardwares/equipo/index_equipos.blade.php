...
@section('contenido')
	...
	<hr>
	<a href="{{route('equipo.generar-pdf-hs')}}" class="btn btn-danger"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> Listado de equipos</a>
	{!! Form::open (['route'=>'equipo.index.hs', 'method'=>'GET', 'class'=>'navbar-form pull-right']) !!}
        ...
        <a href="{{route('equipo.index.hs')}}" class="btn btn-default"> Listar</a>
    {!! Form::close() !!}
    <hr>
