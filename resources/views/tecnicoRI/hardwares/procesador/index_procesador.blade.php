...
@section('contenido')
    ...
    {!! Form::open (['route'=>'procesador.index.tecnicori', 'method'=>'GET', 'class'=>'navbar-form pull-right']) !!}
        ...
        <a href="{{route('procesador.index.tecnicori')}}" class="btn btn-default"> Listar</a>
    {!! Form::close() !!}
